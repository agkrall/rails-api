...
Once it has started up it will print out how to access the database on the virtual machine. It will look something like this:
    ...
    [... truncated ...]
    Your PostgreSQL database has been setup and can be accessed on your local machine on the forwarded port (default: 15437)
      Host: localhost
      Port: 15437
      Database: myapp
      Username: myapp
    ...
    Env variable for application development:
      DATABASE_URL=postgresql://myapp:dbpass@localhost:15437/myapp

    Local command to access the database via psql:
      PGUSER=myapp PGPASSWORD=dbpass psql -h localhost -p 15437 myapp
